<div class="container" style="margin-top:98px;background: aliceblue;">
	<div class="table-wrapper">
		...
		<table class="table table-striped table-hover text-center" id="NoOrder">
			...
			<tbody>
				<?php
					$sql2 = "SELECT DISTINCT orders.orderId AS `orderId` FROM orders JOIN orderitems ON orders.orderId = orderitems.orderId JOIN products ON orderitems.productId = products.productId WHERE products.shopId = '$shopId'";	
					...
					while ($row2 = mysqli_fetch_assoc($result2)) {
						...
						if (getStrLenTH($address) > 20) {
							$address = getSubStrTH($address, 0, 20) . '...';
						}
