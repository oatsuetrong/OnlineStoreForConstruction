<header class="header" id="header">
	...
	<div class="header__img">
		<img src="assetsForSideBar/img/person-<?php echo $shopuserId; ?>.jpg" onError="this.src ='assetsForSideBar/img/perfil.jpg'">
		...
		<div>
			<a href="index.php" class="nav__logo">
				...
				<?php
					...
					echo '<span class="nav__logo-name">' . $systemName . '</span>';
				?>
			</a>
			<div class="nav__list">
