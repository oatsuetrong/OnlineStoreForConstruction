				...
				<div class="container-fluid">
					<div class="row" style="margin: auto;">
						<div class="jumbotron content-panel mb-3 border p-3 col-md-4" style="display: flex; justify-content: center; border: 2px solid rgba(0, 0, 0, 0.1); border-radius: 1.1rem; margin: 0 auto;">
							<div class="user-info">
								<img class="rounded-circle mb-3 bg-dark" src="assetsForSideBar/img/person-<?php echo $userId; ?>.jpg" onError="this.src = 'assetsForSideBar/img/profile.jpg'" style="width:215px; height:215px; padding:1px;">
