<?php
	...
	if (isset($_POST["updateProfilePic"])) {
		...
		if ($check !== false) {
			...
			$uploaddir = $_SERVER['DOCUMENT_ROOT'] . '/website/OnlineStore/admin/assetsForSideBar/img/';
	...
	if (isset($_POST["removeProfilePic"])) {
		$filename = $_SERVER['DOCUMENT_ROOT'] . "/website/OnlineStore/admin/assetsForSideBar/img/person-" . $userId . ".jpg";
