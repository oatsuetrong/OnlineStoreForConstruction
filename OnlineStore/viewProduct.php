	...
	<div class="container my-4" id="cont">
		...
		echo '<div class="col-md-4">
			...
			<div class="col-md-8 my-4">
				<h3>' . $productName . '</h3>
				<h5 style="color: #ff0000">' . $productPrice . ' ฿</h5>
				...
				if ($loggedin) {
					...
					if ($quaExistRows == 0) {
						...
						echo '<a href="viewCartReserved.php"><button class="btn btn-primary my-2">Go to Cart</button></a>';
					}
				} else{
				...
				<div class="mx-4">
					<a href="viewCategoryList.php?catid=' . $productCategorieId . '" class="active text-dark">
					<i class="fas fa-qrcode"></i>
						<span>All Product in the Category</span>
					</a>
				</div>

				<div class="mx-4">
					<a href="viewShop.php?shopId=' . $shopId . '" class="active text-dark">
					<i class="fas fa-qrcode"></i>
						<span>All Product in this Shop</span>
					</a>
				</div>

				<div class="mx-4">
					<a href="viewCompare.php?productCode=' . $productCode . '" class="active text-dark">
					<i class="fas fa-qrcode"></i>
